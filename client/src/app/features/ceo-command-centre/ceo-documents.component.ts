  ...
  template: `
    <div class="module-page">
      <div class="page-header">
        ...
        <h2>Documents</h2>
        <p>Documents pending approval or modified within the past 7 days.</p>
      </div>
      ...
      @if (loading()) {
        ...
        <app-empty-state
          title="No Documents"
          description="No documents pending approval or recently modified."
...
export class CeoDocumentsComponent implements OnInit {
  ...
  loadDocuments(): void {
    ...
    this.error.set(null);
    this.api.get<Document[]>('/ceo-command-centre/documents').subscribe({
      next: (data) => {
